...
//         if (!this.state.specificStatus){
//           // console.log("يارب رحمتك");
//           <Text>{this.state.SpecificStatusText}</Text>
//           console.log("يارب رحمتك");
//           if ("مكتمل"==c.rqeuestStatus){
//             // alert("٢٢٢وبعدين")
//           return (
...
//         if (this.state.specificStatus==false) {
...
//       this.setSpecificStatus(!specificStatus);
//       // specificStatus="true";
...
// this.state.Found?( <ScrollView>{this.list(arrayFiltered2,this.state.SpecificStatusText)}</ScrollView>):(null)
// ):
// ( <ScrollView>{this.list(requestArray,null)}</ScrollView> )}
